...
/**
 * insertion_sort_deck_value - sort a deck of cards from spades to diamonds from ace to king
 * @deck: a pointer to the head of a deck_node_t doubly-linked list
 */
void insertion_sort_deck_value(deck_node_t **deck)
{
...
tmp = iter->next;
insert = iter->prev;
while (insert != NULL && insert->card->kind && get_value(insert) > get_value(iter))
{
insert->next = iter->next;
if (iter->next != NULL)
iter->next->prev = insert;
...
/**
 * sort_deck - sort a deck of cards from ace to king and from spade to diamonds
 * @deck: a pointer to the head of a deck_node_t doubly-linked list
 */
void sort_deck(deck_node_t **deck)
{
